...
import GhostSuggestionSettings from '../settings/GhostSuggestionSettings.vue'
import GlobalSpeechSettings from '../settings/GlobalSpeechSettings.vue'
import IterateSettings from '../settings/IterateSettings.vue'
import PromptLibrarySettings from '../settings/PromptLibrarySettings.vue'
import ReplySettings from '../settings/ReplySettings.vue'
import ShortcutSettings from '../settings/ShortcutSettings.vue'
import SpeechMuscleMemorySettings from '../settings/SpeechMuscleMemorySettings.vue'
...
<template>
  <div class="max-w-3xl mx-auto tab-content">
    <n-collapse size="large" :default-expanded-names="[]" arrow-placement="right">
      ...
      <!-- 幽灵补全设置 -->
      <n-collapse-item name="ghost-suggestions">
        <template #header>
          <div class="flex items-center justify-between w-full">
            <div class="flex items-center">
              <div class="w-10 h-10 rounded-lg bg-cyan-100 dark:bg-cyan-900 flex items-center justify-center mr-4">
                <div class="i-carbon-machine-learning-model text-lg text-cyan-600 dark:text-cyan-400" />
              </div>
              <div>
                <div class="text-lg font-medium tracking-tight mb-1">
                  幽灵补全词表
      ...
      <n-collapse-item name="global-speech">
        <template #header>
          <div class="flex items-center justify-between w-full">
            <div class="flex items-center">
              <div class="w-10 h-10 rounded-lg bg-rose-100 dark:bg-rose-900 flex items-center justify-center mr-4">
                <div class="i-carbon-voice-activate text-lg text-rose-600 dark:text-rose-400" />
              </div>
              <div>
                <div class="text-lg font-medium tracking-tight mb-1">
                  全局语音输入
      ...
      <n-collapse-item name="speech-muscle-memory">
        <template #header>
          <div class="flex items-center justify-between w-full">
            <div class="flex items-center">
              <div class="w-10 h-10 rounded-lg bg-purple-100 dark:bg-purple-900 flex items-center justify-center mr-4">
                <div class="i-carbon-machine-learning-model text-lg text-purple-600 dark:text-purple-400" />
              </div>
              <div>
                <div class="text-lg font-medium tracking-tight mb-1">
                  肌肉记忆库
      ...
      <!-- iterate 远程控制 (Bridge Server + 手机同步) -->
      <n-collapse-item name="iterate">
        <template #header>
          <div class="flex items-center justify-between w-full">
            <div class="flex items-center">
              <div class="w-10 h-10 rounded-lg bg-violet-100 dark:bg-violet-900 flex items-center justify-center mr-4">
                <div class="i-carbon-cloud-satellite-link text-lg text-violet-600 dark:text-violet-400" />
              </div>
              <div>
                <div class="text-lg font-medium tracking-tight mb-1">
                  iterate
      ...
      <!-- 自动检查点 -->
      <n-collapse-item name="checkpoint">
        <template #header>
          <div class="flex items-center justify-between w-full">
            <div class="flex items-center">
              <div class="w-10 h-10 rounded-lg bg-orange-100 dark:bg-orange-900 flex items-center justify-center mr-4">
                <div class="i-carbon-save text-lg text-orange-600 dark:text-orange-400" />
              </div>
              <div>
                <div class="text-lg font-medium tracking-tight mb-1">
                  自动检查点
      ...
      <!-- 提示词库 -->
      <n-collapse-item name="prompt-library">
        <template #header>
          <div class="flex items-center justify-between w-full">
            <div class="flex items-center">
              <div class="w-10 h-10 rounded-lg bg-teal-100 dark:bg-teal-900 flex items-center justify-center mr-4">
                <div class="i-carbon-catalog text-lg text-teal-600 dark:text-teal-400" />
              </div>
              <div>
                <div class="text-lg font-medium tracking-tight mb-1">
                  提示词库
