...
/// 应用程序主页
pub const HOMEPAGE: &str = "https://github.com/kexin94yyds/iterate";

/// 应用程序仓库
pub const REPOSITORY: &str = "https://github.com/kexin94yyds/iterate";
...
/// 应用程序标识符（用于系统集成）
pub const APP_IDENTIFIER: &str = "com.kexin94yyds.iterate";
